package com.epamhometask.calculatorapplication.Controller;

import com.epamhometask.calculatorapplication.Modal.MathOperations;
...
public class MathOperationsController {
    ...
    public String result(@RequestParam String leftOperand, @RequestParam String operator, @RequestParam String rightOperand
        , Model model)
        {
            ...
            MathOperations mathOperations = new MathOperations(leftNumber,rightNumber,operator);
            double result = mathOperations.calculateResult();
